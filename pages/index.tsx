          ...
          <div className='mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24'>
            <div>
              <div className='flex items-center'>
                <img
                  className='inline h-11 w-auto pr-2'
                  src='https://tailwindui.com/img/logos/workflow-mark.svg?color=rose&shade=500'
                  alt='Workflow'
                />
                <h1 className='text-4xl font-extrabold text-gray-900 inline-block tracking-tight sm:text-5xl'>
                  Eventful
                </h1>
              </div>
              <div className='mt-20'>
                <div className='mt-6 sm:max-w-xl'>
                  ...
                  <p className='mt-6 text-xl text-gray-500'>
                    Discover and experience a new way of life and eventing.
                    Attend charitable events, or organize one yourself.
                  </p>
                </div>
                <form
                  action='#'
            ...
            <div className='lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center'>
              <div>
                <h2 className='text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl'>
                  Built using the latest web dev technologies
                </h2>
                <p className='mt-6 max-w-3xl text-lg leading-7 text-gray-500'>
                  We built this project using cutting-edge web development
                  technologies, for a blazingly fast experience. Powered by Java
                  Spring Boot Backend, PostgreSQL to handle the database, and
                  Vercels Next.JS shipping the front-end of the application.
                </p>
                <div className='mt-6'>
                  <a href='#' className='text-base font-medium text-rose-500'>
      ...
      <footer className='mt-24 bg-gray-900 sm:mt-12'>
        <div className='mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8'>
          ...
          <p className='mt-8 text-center text-base text-gray-400'>
            Andrej Hristov &#123; 173134 &#125; and Andrej Mazhenkovski &#123;
            173133 &#125; <br />
            Project for Web Development Course. <br /> &copy; 2022 Students
            FINKI.
          </p>
        </div>
      </footer>
