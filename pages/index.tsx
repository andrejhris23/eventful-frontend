                ...
                <Link href='/'>
                  <a className='flex items-center'>
                    <img
                      ...
                      height={64}
                    />
                    <h2 className='text-4xl font-bold ml-2 inline-block flex-row items-center'>
                      Eventful
                    </h2>
                  </a>
                </Link>
              ...
              <div className='mt-20'>
                <div className='mt-6 sm:max-w-xl'>
                  ...
                  <p className='mt-6 text-xl text-gray-500'>
                    Browse to a collection of events happening all around the
                    world. Purchase tickets and enjoy them!
                  </p>
                </div>
                <form
                  action='#'
                    ...
                    <blockquote className='mt-8'>
                      <div className='relative text-lg font-medium text-white md:flex-grow'>
                        ...
                        <p className='relative'>
                          Our events started to get way more traction once we
                          decided to post them on Eventful.
                        </p>
                      </div>
      ...
      <footer className='mt-24 bg-gray-900 sm:mt-12'>
        <div className='mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8'>
          ...
          <p className='mt-8 text-center text-base text-gray-400'>
            &copy; 2022 Eventful, Inc. All rights reserved. FINKI Web
            Development Project
            <br /> Andrej Hristov &#123; 173134 &#125; & Andrej Mazhenkovski
            &#123; 173133 &#125;
          </p>
        </div>
      </footer>
